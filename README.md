...
#### `SOPKA_DEPLOY_LIST` and `SOPKA_SECRETS_DEPLOY_LIST`

A list of strings, use it to specify things to deploy, and query them with `sopka::should_deploy` and `sopka::should_deploy_secrets` later.
